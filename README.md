...
From 2022–2024, the FMCG (Fast-Moving Consumer Goods) sales peaked at $891K in July 2023, driven by a new yogurt SKU (YO-024). Yogurt remains the core sales of the business (~40% of revenue) but is gradually shrinking, while Snack Bars are the fastest-growing segment. Year-over-year, order count rose 8.3%, yet total revenue declined slightly by 1.05%, reflecting an 8.6% drop in Average Order Value (AOV), indicating higher transaction volume but lower revenue per order. Non-promotional sales drove $14.8M in revenue, while promotions effectively increased order value. Retail remains the top channel, though E-commerce surged to a 66.9% share in 2023–2024, marking a major channel shift. Regionally, PL-South overtook PL-North in 2023, which shows how a new product launches can reshape the market dynamics.
